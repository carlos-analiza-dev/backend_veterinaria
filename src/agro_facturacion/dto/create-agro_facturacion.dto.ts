...
import { CreateAgroFacturaDetalleDto } from './create-agro_factura_detalle.dto';
import {
  EstadoFactura,
  FormaPago,
} from 'src/factura_encabezado/entities/factura_encabezado.entity';

export class CreateAgroFacturacionDto {
  ...
  @Type(() => CreateAgroFacturaDetalleDto)
  detalles: CreateAgroFacturaDetalleDto[];
