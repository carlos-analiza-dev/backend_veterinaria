...
@Injectable()
export class DescuentoAgroProductoService {
  constructor(
    @InjectRepository(DescuentosProductoAgro)
    private readonly descuentoRepository: Repository<DescuentosProductoAgro>,
    @InjectRepository(AgroProducto)
    private readonly productoRepository: Repository<AgroProducto>,
  ...
  async create(createDescuentosProductoDto: CreateDescuentosAgroProductoDto) {
    const {
      cantidad_comprada,
      descuentos,
      productoId,
  ...
  async update(
    id: string,
    updateDescuentosProductoDto: UpdateAgroDescuentoProductoDto,
  ) {
    try {
